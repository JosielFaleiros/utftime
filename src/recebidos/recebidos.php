  ...
  <div class="row content">
    ...
    <div class="container-fluid cont">
                  ...
                  <tbody>
                    ...
                    <td><?= $result["item"]?></td>
                    <td><?= $result["pontos"]?></td>
                    <td><i onclick="document.getElementsByClassName('rowTable')[<?= $count?>].style.display = 'none'" class="glyphicon glyphicon-ok-circle aprovado"></i></td>
                    <td><i onclick="document.getElementsByClassName('rowTable')[<?= $count++?>].style.display = 'none'" class="glyphicon glyphicon-remove-circle devolvido"></i></td>
